...
export class AppComponent implements OnInit{
  ...
  icons = [];
  area = ['Πρός Πειραιά', 'Πρός Λαύριο', 'Από Λαύριο', 'Πρός Καβάλα', 'Πρός Σαμοθράκη', 'Πρός Αλεξανδρούπολη', 'Πρός Άγιο Ευστράτιο', 'Πρός Μυτιλήνη', 'Πρός Χίο', 'Πρός Σάμο',
    'To Peireus', 'To Lavrio', 'From Lavrio', 'To Kavala', 'To Samothraki', 'To Alexandroupoli', 'To Agio Eustratio', 'To Mytilini', 'To Xios', 'To Samos'];
  ...
  dromologia_total = [this.dromologia_peiraias_gr, this.dromologia_laurio_gr, this.dromologia_from_laurio_gr, this.dromologia_kavala_gr, this.dromologia_samothraki_gr,
    ...
    this.dromologia_peiraias_en, this.dromologia_laurio_en, this.dromologia_from_laurio_en, this.dromologia_kavala_en, this.dromologia_samothraki_en,
